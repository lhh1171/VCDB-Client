...
public class ActiveAndInActiceHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        ActionEntity actionEntity = toRequestEntity(msg);
    ...
    public ActionEntity toRequestEntity(Object msg){
        FullHttpRequest fullHttpRequest =(FullHttpRequest) msg;
        String content = fullHttpRequest.content().toString(CharsetUtil.UTF_8);
        return new ActionEntity(fullHttpRequest.getMethod().name(),fullHttpRequest.getUri());
    }
}
